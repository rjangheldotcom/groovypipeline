...
sh "echo $BUILD_NUM"
  stage('DeployToQA'){
       ...
       sh  "sudo docker run --rm  --name altidemoqa -d -p 8082:8080 vkotteswaran/altidemopipeline:$BUILD_NUM"
    }
 ...
 stage('Deploy to Prod?') {
        ...
        sh "sudo docker run --rm --name altidemoprod -d -p 8083:8080 vkotteswaran/altidemopipeline:$BUILD_NUM"
    }
